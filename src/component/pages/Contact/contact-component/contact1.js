...
const ContactUs = () => {
    ...
    return (
        ...
        <>
            <section
                className="relative mt-12 md:mt-20 lg:mt-24 w-full h-[400px] sm:h-[450px] md:h-[500px] bg-cover bg-center flex items-center"
                    ...
                    <div className="w-full sm:w-3/4 md:w-1/2 flex flex-col justify-center text-center">
                        ...
                        <div>
                            <a
                                ...
                                href="#"
                                className="inline-block mt-2 px-4 py-2 bg-white text-blue-900 font-semibold rounded-3xl shadow-md hover:bg-black hover:text-white transition"
                            >
                                CONTACT US TODAY!
                            </a>
                        </div>
