  ...
  return (
    <>
      ...
      <div className="mt-10 mb-12 w-full text-center px-4">
        ...
        <button className="mt-3 bg-blue-900 text-white px-10 py-2 rounded-full text-sm sm:text-[15px] border hover:bg-white hover:text-blue-900 transition shadow-md">
          Apply Now
        </button>
      </div>
    </>
