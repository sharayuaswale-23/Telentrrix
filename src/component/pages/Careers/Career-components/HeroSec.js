...
const HeroSec = () => {
  return (
    <div
      className="relative mt-12 md:mt-20 lg:mt-24 flex flex-col items-center md:items-end justify-center text-center p-5 bg-cover bg-center h-[451px]"
    ...
    >
      <div className="bg-transparent bg-opacity-90 p-5 w-full md:w-[60%] lg:w-[43%]">
        ...
        <div className="w-full flex justify-center mt-4">
          <div className="flex flex-col sm:flex-row gap-2 lg:gap-6 w-full md:w-[84%]">
            <button className="w-full  bg-white text-blue-900 font-semibold py-2 px-4 rounded-full text-sm sm:text-lg shadow-md hover:bg-gray-200">
              Consulting Jobs
            </button>
            <button className="w-full  bg-white text-blue-900 font-semibold py-2 px-4  rounded-full text-sm sm:text-lg shadow-md hover:bg-gray-200">
              Corporate Jobs
