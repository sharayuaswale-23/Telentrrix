    ...
    >
      <div className="container mx-auto flex items-center justify-between h-full">
        ...
        <nav className="hidden lg:flex space-x-6 items-center">
          ...
          {/* Other Menu Items */}
          <a href="#" className="text-gray-700 hover:bg-blue-700 hover:text-white hover:px-4 hover:py-2 hover:rounded-full">
    ...
    <FiX />
          ...
          <nav className="mt-4 px-5">
            ...
            <div className="border-b border-gray-600 py-3">
              ...
              {dropdowns.about && (
                <div className="pl-4 mt-2">
                  <a href="#" className="block border-b border-gray-700 py-2">Artech Advantage</a>
                  <a href="#" className="block border-b border-gray-700 py-2">Great Place to Work</a>
                  <a href="#" className="block border-b border-gray-700 py-2">Awards</a>
                  <a href="#" className="block py-2">Certifications and Accolades</a>
                </div>
              )}
            </div>
            ...
            <button onClick={() => toggleDropdown("solutions")} className="text-lg flex justify-between w-full text-left">
              ...
              {dropdowns.solutions && (
                <div className="pl-4 mt-2">
                  <a href="#" className="block border-b border-gray-700 py-2">IT Solutions</a>
                  <a href="#" className="block border-b border-gray-700 py-2">Consulting Services</a>
                  <a href="#" className="block py-2">Project Management</a>
                </div>
              )}
            </div>
            ...
            <div className="border-b border-gray-600 py-3">
              ...
              {dropdowns.careers && (
                <div className="pl-4 mt-2">
                  <a href="#" className="block border-b border-gray-700 py-2">Corporate Jobs</a>
                  <a href="#" className="block py-2">Consultant Jobs</a>
                </div>
              )}
            </div>
